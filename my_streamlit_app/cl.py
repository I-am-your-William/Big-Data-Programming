...
def main():
    ...
    def load_data_state():
        # Load the data
        file_path = 'C:/zhengyang/Inti/BCSCUN/Sem 6/Big Data/cleaned_dataset/cleaned_cases_state.csv'  # Update with your file path if running locally
    ...
    def load_data_district():
        # Load the data
        file_path = 'C:/zhengyang/Inti/BCSCUN/Sem 6/Big Data/cleaned_dataset/cleaned_cluster.csv'
